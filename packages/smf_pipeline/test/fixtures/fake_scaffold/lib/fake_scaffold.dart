...
/// use.
///
/// It provides the app entry until the flutter_core module does: the Dart
/// entry point with every socket of the app entry, the pubspec with the
/// sockets of the pipeline, and native files that only hold the tags of the
/// native sockets. They are not a buildable Android or iOS project, and the
/// minimum iOS version appears only in the Podfile.
library;
